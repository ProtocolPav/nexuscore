...
class UserQuestModel(BaseModel):
    ...
    @classmethod
    async def create(cls, db: Database, model: "UserQuestCreateModel", *args) -> int:
            ...
            async with conn.transaction():
                ...
                for objective in objectives_list:
                    ...
                    await conn.execute("""
                                       ...
                                       VALUES($1, $2, $3)
                                       """,
                                       model.quest_id, model.thorny_id, objective.objective_id)
...
class UserQuestCreateModel(UserQuestBaseModel):
    pass
