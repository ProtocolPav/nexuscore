...
@openapi.response(content={"application/json": objects.ProfileModel.model_json_schema(ref_template="#/components/schemas/{model}")})
...
@openapi.response(content={"application/json": objects.PlaytimeReport.model_json_schema(ref_template="#/components/schemas/{model}")})
...
@openapi.response(status=200, content={'application/json': objects.UserObject.model_json_schema(ref_template="#/components/schemas/{model}")},
                  description='Success')
@openapi.response(status=404, description='Error')
